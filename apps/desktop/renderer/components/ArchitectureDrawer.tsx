...
export const ArchitectureDrawer: React.FC<ArchitectureDrawerProps> = ({ isOpen, onClose }) => {
  ...
  const phase1Modules = [
    ...
    {
      name: 'Voice Engine (Phase 3)',
      desc: 'Dual Web Speech & Mock backend, interruption detection, privacy speech filter, and multi-language support.',
      status: 'Active',
      tech: 'core/voice/voiceEngine.ts',
    },
    {
      name: 'Notification Intelligence & Privacy Shield (Phase 4)',
      desc: 'Local-first classification, non-bypassable OTP purge, quiet hours, cooldown, and safe speech routing.',
      status: 'Active',
